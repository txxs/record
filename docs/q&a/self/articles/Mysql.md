...
18. Null 是如何记录和存储的
    ...
    2. 存储
        ...
        ![图片](https://txxs.github.io/pic/q&a/16cb6f08d1c53f83.jpeg)       
...
10. undo Log作用
用于快照读和事务失败后的数据回滚,MySQL在合适的时机会清理undo Log，undo Log中记录的就是多版本数据。
...
4. mysql执行计划explain
![图片](https://txxs.github.io/pic/q&a/2021012617383743.jpeg)
其中各字段的含义为：
