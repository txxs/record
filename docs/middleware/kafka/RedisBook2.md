...
如下图所示：
![image.png](https://txxs.github.io/pic/interviewGuide-storage/12609483-d09569b3e780120b.png)
...
![image.png](https://txxs.github.io/pic/interviewGuide-storage/12609483-5d5aecc951557f56.png)
...
![image.png](https://txxs.github.io/pic/interviewGuide-storage/12609483-1829498245a5787b.png)
...
![image.png](https://txxs.github.io/pic/interviewGuide-storage/12609483-a1800dd48244e22d.png)
...
![image.png](https://txxs.github.io/pic/interviewGuide-storage/12609483-d84b28aaf117b063.png)
...
![image.png](https://txxs.github.io/pic/interviewGuide-storage/12609483-51f11addf81dd7bf.png)
Sentinel之间不会创建订阅连接
...
![。](https://txxs.github.io/pic/interviewGuide-storage/12609483-6264bb0a50df8696.png)
clusterNode结构的link属性是一个clusterLink结构，该结构保存了连接节点所需的有关信息，比如套接字描述符，输入缓冲区和输出缓冲区等。（有点类似于redisClient结构中用于连接客户端的套接字，缓冲区）
![image.png](https://txxs.github.io/pic/interviewGuide-storage/12609483-6f7331032865b57b.png)
每个节点都保存着一个clusterState结构，这个结构记录了在当前节点的视角下，集群目前所处的状态，例如集群是在线还是下线，集群包含多少个节点，集群当前的配置纪元等。
![image.png](https://txxs.github.io/pic/interviewGuide-storage/12609483-fbee5c2cfb8601da.png)
...
![image.png](https://txxs.github.io/pic/interviewGuide-storage/12609483-b20cd2594752fad8.png)
下图展示了一个slots数组示例：这个数组索引0至索引7上的二进制位的值都为1，其余所有二进制位的值都为0，这表示节点负责处理槽0至槽7。
![image.png](https://txxs.github.io/pic/interviewGuide-storage/12609483-b201b1635c4b2125.png)

##### 记录集群所有槽的指派信息
除了记录自身节点负责的槽位信息以外，clusterState结构中的slots数组记录了集群中所有16384个槽的指派信息。
![image.png](https://txxs.github.io/pic/interviewGuide-storage/12609483-f4dc3c2e06dc055e.png)
...
![image.png](https://txxs.github.io/pic/interviewGuide-storage/12609483-49b9a8d5e04cce51.png)
除了将键值对保存在数据库里面之外，节点还会用clusterState结构中的slots_to_keys跳跃表来保存槽和键之间的关系。slots_to_keys跳跃表每个节点的分值保存键对应的槽位，每个节点的成员都是一个数据库键，如下图所示：
![image.png](https://txxs.github.io/pic/interviewGuide-storage/12609483-df3aa06eac8be3cc.png)
![image.png](https://txxs.github.io/pic/interviewGuide-storage/12609483-daa1017965210d79.png)
...
![image.png](https://txxs.github.io/pic/interviewGuide-storage/12609483-9cef67ecb52a18dc.png)
...
ASK
![image.png](https://txxs.github.io/pic/interviewGuide-storage/12609483-0b76181613ab9b88.png)
![image.png](https://txxs.github.io/pic/interviewGuide-storage/12609483-a5913adb192d42b8.png)
...
![image.png](https://txxs.github.io/pic/interviewGuide-storage/12609483-17b68c0d6e4a8c69.png)
...
![image.png](https://txxs.github.io/pic/interviewGuide-storage/12609483-3230f1f23b429264.png)
...
如下图所示：
![image.png](https://txxs.github.io/pic/interviewGuide-storage/12609483-2cc427780dabbd24.png)
...
![image.png](https://txxs.github.io/pic/interviewGuide-storage/12609483-21d0ef9d804fa018.png)
...
![image.png](https://txxs.github.io/pic/interviewGuide-storage/12609483-b683204e668de0d9.png)
...
![image.png](https://txxs.github.io/pic/interviewGuide-storage/12609483-73f1c52b4c03b738.png)

2）遍历数组，将各个数组项的obj指针分别指向numbers列表的各个项，构成obj指针和列表项之间的一对一关系，如图21-2所示。
![image.png](https://txxs.github.io/pic/interviewGuide-storage/12609483-36a4169adca877d7.png)

3）遍历数组，将各个obj指针所指向的列表项转换成一个double类型的浮点数，并将这个浮点数保存在相应数组项的u.score属性里面，如图所示。
![image.png](https://txxs.github.io/pic/interviewGuide-storage/12609483-15f831546f662ac9.png)
4）根据数组项u.score属性的值，对数组进行数字值排序，排序后的数组项按u.score属性的值从小到大排列，如图所示。
![image.png](https://txxs.github.io/pic/interviewGuide-storage/12609483-072e5f8dfe85b67a.png)
...
![image.png](https://txxs.github.io/pic/interviewGuide-storage/12609483-3b85e8021cd8e8d0.png)
...
![image.png](https://txxs.github.io/pic/interviewGuide-storage/12609483-025e4bf14ce8dc40.png)
...
![image.png](https://txxs.github.io/pic/interviewGuide-storage/12609483-e9060f6bdd9b95fa.png)
...
![image.png](https://txxs.github.io/pic/interviewGuide-storage/12609483-47571d940363c993.png)