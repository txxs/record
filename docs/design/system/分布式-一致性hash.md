...
![](https://txxs.github.io/pic/javainterview/一致性hash1.jpg)

之后将各个节点散列到这个环上，可以用节点的 IP、hostname 这样的唯一性字段作为 Key 进行 `hash(key)`，散列之后如下：

![](https://txxs.github.io/pic/javainterview/一致性hash2.jpg)

之后需要将数据定位到对应的节点上，使用同样的 `hash 函数` 将 Key 也映射到这个环上。

![](https://txxs.github.io/pic/javainterview/一致性hash3.jpg)
...
![](https://txxs.github.io/pic/javainterview/一致性hash4.jpg)
...
![](https://txxs.github.io/pic/javainterview/一致性hash5.jpg)
...
![](https://txxs.github.io/pic/javainterview/一致性hash6.jpg)

这样会导致大部分数据都在 N1 节点，只有少量的数据在 N2 节点。

为了解决这个问题，一致哈希算法引入了虚拟节点。将每一个节点都进行多次 hash，生成多个节点放置在环上称为虚拟节点:

![](https://txxs.github.io/pic/javainterview/一致性hash7.jpg)
