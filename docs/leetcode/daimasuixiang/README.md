...
* [「代码随想录」后前序安排](https://mp.weixin.qq.com/s/4eeGJREy6E-v6D7cR_5A4g)
...
* 工具 
    ...
    * [程前序员应该用什么用具来写文档？](problems/前序/程前序员写文档工具.md)

* 求职 
    * [程前序员的简历应该这么写！！（附简历模板）](problems/前序/程前序员简历.md)
    * [BAT级别技术面试流程和注意事项都在这里了](problems/前序/BAT级别技术面试流程和注意事项都在这里了.md)
    * [北京有这些互联网公司，你都知道么？](problems/前序/北京互联网公司周总结.md)
    * [上海有这些互联网公司，你都知道么？](problems/前序/上海互联网公司周总结.md)
    * [深圳有这些互联网公司，你都知道么？](problems/前序/深圳互联网公司周总结.md)
    * [广州有这些互联网公司，你都知道么？](problems/前序/广州互联网公司周总结.md)
    * [成都有这些互联网公司，你都知道么？](problems/前序/成都互联网公司周总结.md)
    * [杭州有这些互联网公司，你都知道么？](problems/前序/杭州互联网公司周总结.md)
...
* 算法性能分析
    ...
    * [本周小结！（算法性能分析系列一）](problems/周总结/20201210复杂度分析周末周总结.md)
...
* [秋招面试，心态很重要！](problems/知识星球精选/秋招周总结3.md)
* [秋招倒霉透顶，触底反弹！](problems/知识星球精选/秋招周总结2.md)
* [无竞赛，无实习，如何秋招？](problems/知识星球精选/秋招周总结1.md)
...
* [非科班2021秋招周总结](problems/知识星球精选/非科班2021秋招周总结.md)
...
* [Carl看了上百份简历，周总结了这些！](problems/知识星球精选/写简历的一些问题.md)
...
11. [哈希表：周总结篇！（每逢周总结必经典）](problems/0希表周总结.md)
...
9. [哈希表：解决了两数之和，那么能解决三数之和么？](problems/0015.三数之和.md)
10. [双指针法：一样的道理，能解决四数之和](problems/0018.四数之和.md)
11. [双指针法：周总结篇！](problems/0指针周总结.md)
...
5. [栈与队列：匹配问题都是栈的强项](problems/0047.删除字符串中的所有相邻重复项.md)
...
9. [栈与队列：周总结篇！](problems/0与队列周总结.md)
...
2. [二叉树：一入递归深似海，从此offer是路人](problems/0叉树的递归遍历.md)
3. [二叉树：听说递归能做的，栈也能做！](problems/0叉树的迭代遍历.md)
4. [二叉树：前中后前序迭代方式的写法就不能统一一下么？](problems/0叉树的统一迭代法.md)
5. [二叉树：层前序遍历登场！](problems/0102.二叉树的层前序遍历.md) 
6. [二叉树：你真的会翻转二叉树么？](problems/0226.翻转二叉树.md)
7. [本周小结！（二叉树）](problems/周总结/20200927二叉树周末周总结.md)
...
14. [本周总结！二叉树系列二](problems/周总结/20201003二叉树周末周总结.md)
15. [二叉树：以为使用了递归，其实还隐藏着回溯](problems/0叉树中递归带着回溯.md)
...
19. [二叉树：构造二叉树登场！](problems/0106.从中前序与后前序遍历前序列构造二叉树.md)
20. [二叉树：构造一棵最大的二叉树](problems/0654.最大二叉树.md)
21. [本周小结！（二叉树系列三）](problems/周总结/20201010二叉树周末周总结.md) 
...
28. [本周小结！（二叉树系列四）](problems/周总结/20201017二叉树周末周总结.md)
...
33. [二叉树：构造一棵搜索树](problems/0108.将有前序数组转换为二叉搜索树.md)
34. [二叉树：搜索树转成累加树](problems/0538.把二叉搜索树转换为累加树.md)
35. [二叉树：周总结篇！（需要掌握的二叉树技能都在这里了）](problems/0叉树周总结篇.md)
...
6. [本周小结！（回溯算法系列一）](problems/周总结/20201030回溯周末周总结.md)
...
12. [本周小结！（回溯算法系列二）](problems/周总结/20201107回溯周末周总结.md)
13. [回溯算法：求子集问题（二）](problems/0090.子集II.md)
14. [回溯算法：递增子前序列](problems/0491.递增子前序列.md)
15. [回溯算法：排列问题！](problems/0046.全排列.md)
16. [回溯算法：排列问题（二）](problems/0047.全排列II.md)
17. [本周小结！（回溯算法系列三）](problems/周总结/20201112回溯周末周总结.md)
18. [回溯算法去重问题的另一种写法](problems/0溯算法去重问题的另一种写法.md)
19. [回溯算法：重新安排行程](problems/0332.重新安排行程.md)
20. [回溯算法：N皇后问题](problems/0051.N皇后.md)
21. [回溯算法：解数独](problems/0037.解数独.md)
22. [一篇周总结带你彻底搞透回溯算法！](problems/0溯周总结.md)
...
3. [贪心算法：摆动前序列](problems/0376.摆动前序列.md)
4. [贪心算法：最大子前序和](problems/0053.最大子前序和.md)
5. [本周小结！（贪心算法系列一）](problems/周总结/20201126贪心周末周总结.md)
6. [贪心算法：买卖股票的最佳时机II](problems/0122.买卖股票的最佳时机II.md)
7. [贪心算法：跳跃游戏](problems/0055.跳跃游戏.md)
8. [贪心算法：跳跃游戏II](problems/0045.跳跃游戏II.md)
9. [贪心算法：K次取反后最大化的数组和](problems/0005.K次取反后最大化的数组和.md)
10. [本周小结！（贪心算法系列二）](problems/周总结/20201203贪心周末周总结.md)
...
15. [本周小结！（贪心算法系列三）](problems/周总结/20201217贪心周末周总结.md)
16. [贪心算法：根据身高重建队列（续集）](problems/0据身高重建队列（vector原理讲解）.md)
...
21. [本周小结！（贪心算法系列四）](problems/周总结/20201224贪心周末周总结.md)
...
25. [贪心算法：周总结篇！（每逢周总结必经典）](problems/0心算法周总结篇.md)

## 动态规划

动态规划专题已经开始啦，来不及解释了，小伙伴们上车别掉队！

<img src='https://code-thinking.cdn.bcebos.com/pics/动态规划-周总结大纲1.jpg' width=500> </img></div>
1. [关于动态规划，你该了解这些！](./problems/0动态规划理论基础.md)
2. [动态规划：斐波那契数](./problems/00509.斐波那契数.md)
3. [动态规划：爬楼梯](./problems/00070.爬楼梯.md)
4. [动态规划：使用最小花费爬楼梯](./problems/00746.使用最小花费爬楼梯.md)
5. [本周小结！（动态规划系列一）](./problems/周总结/20210107动规周末周总结.md)
6. [动态规划：不同路径](./problems/00062.不同路径.md)
7. [动态规划：不同路径还不够，要有障碍！](./problems/00063.不同路径II.md)
8. [动态规划：整数拆分，你要怎么拆？](./problems/00343.整数拆分.md)
9. [动态规划：不同的二叉搜索树](./problems/00096.不同的二叉搜索树.md)
10. [本周小结！（动态规划系列二）](./problems/周总结/20210114动规周末周总结.md)

背包问题系列：

<img src='https://code-thinking.cdn.bcebos.com/pics/动态规划-背包问题周总结.png' width=500 alt='背包问题大纲'> </img></div>


11. [动态规划：关于01背包问题，你该了解这些！](problems/背包理论基础01背包-1.md)
12. [动态规划：关于01背包问题，你该了解这些！（滚动数组）](problems/0包理论基础01背包-2.md)
13. [动态规划：分割等和子集可以用01背包！](problems/0416.分割等和子集.md)
14. [动态规划：最后一块石头的重量 II](problems/0049.最后一块石头的重量II.md)
15. [本周小结！（动态规划系列三）](problems/周总结/20210121动规周末周总结.md)
16. [动态规划：目标和！](problems/0494.目标和.md)
17. [动态规划：一和零！](problems/0474.一和零.md) 
18. [动态规划：关于完全背包，你该了解这些！](problems/0包问题理论基础完全背包.md)
19. [动态规划：给你一些零钱，你要怎么凑？](problems/0518.零钱兑换II.md)
20. [本周小结！（动态规划系列四）](problems/周总结/20210128动规周末周总结.md)
...
25. [本周小结！（动态规划系列五）](problems/周总结/20210204动规周末周总结.md)
26. [动态规划：单词拆分](problems/0139.单词拆分.md)
27. [动态规划：关于多重背包，你该了解这些！](problems/0包问题理论基础多重背包.md)
28. [听说背包问题很难？ 这篇周总结篇来拯救你了](problems/0包周总结篇.md)
...
<img src='https://code-thinking.cdn.bcebos.com/pics/股票问题周总结.jpg' width=500 alt='股票问题周总结'> </img></div>


32. [动态规划：买卖股票的最佳时机](problems/0121.买卖股票的最佳时机.md)
33. [动态规划：本周我们都讲了这些（系列六）](problems/周总结/20210225动规周末周总结.md)
...
38. [动态规划：本周我们都讲了这些（系列七）](problems/周总结/20210304动规周末周总结.md)
39. [动态规划：买卖股票的最佳时机含手续费](problems/0714.买卖股票的最佳时机含手续费（动态规划）.md)
40. [动态规划：股票系列周总结篇](problems/0态规划-股票问题周总结篇.md)

子前序列系列： 

<img src='https://code-thinking.cdn.bcebos.com/pics/动态规划-子前序列问题周总结.jpg' width=500 alt=''> </img></div>


41. [动态规划：最长递增子前序列](problems/0300.最长上升子前序列.md)
42. [动态规划：最长连续递增前序列](problems/0674.最长连续递增前序列.md)
43. [动态规划：最长重复子数组](problems/0718.最长重复子数组.md)
44. [动态规划：最长公共子前序列](problems/0143.最长公共子前序列.md)
45. [动态规划：不相交的线](problems/0035.不相交的线.md)
46. [动态规划：最大子前序和](problems/0053.最大子前序和（动态规划）.md)
47. [动态规划：判断子前序列](problems/0392.判断子前序列.md)
48. [动态规划：不同的子前序列](problems/0115.不同的子前序列.md)
49. [动态规划：两个字符串的删除操作](problems/0583.两个字符串的删除操作.md)
50. [动态规划：编辑距离](problems/0072.编辑距离.md)
51. [为了绝杀编辑距离，Carl做了三步铺垫，你都知道么？](problems/0了绝杀编辑距离，卡尔做了三步铺垫.md)
52. [动态规划：回文子串](problems/0647.回文子串.md)
53. [动态规划：最长回文子前序列](problems/0516.最长回文子前序列.md)
54. [动态规划周总结篇](problems/0态规划周总结篇.md)
...
* [1365.有多少小于当前数字的数字](problems/0365.有多少小于当前数字的数字.md)
* [941.有效的山脉数组](problems/0941.有效的山脉数组.md)  （双指针）
* [1207.独一无二的出现次数](problems/0207.独一无二的出现次数.md) 数组在哈希法中的经典应用
* [283.移动零](problems/0283.移动零.md) 【数组】【双指针】
* [189.旋转数组](problems/0189.旋转数组.md)
* [724.寻找数组的中心索引](problems/0724.寻找数组的中心索引.md)
* [34.在排前序数组中查找元素的第一个和最后一个位置](problems/0034.在排前序数组中查找元素的第一个和最后一个位置.md) （二分法）
* [922.按奇偶排前序数组II](problems/0922.按奇偶排前序数组II.md) 
...
* [160.相交链表](problems/0试题02.07.链表相交.md)
...
* [1382.将二叉搜索树变平衡](problems/0382.将二叉搜索树变平衡.md) 构造平衡二叉搜索树
...
* [1221.分割平衡字符](problems/0221.分割平衡字符串.md) 简单贪心
...
* [673.最长递增子前序列的个数](problems/0673.最长递增子前序列的个数.md) 
...
## 位运算
* [1356.根据数字二进制下1的数目排前序](problems/0356.根据数字二进制下1的数目排前序.md) 


# 算法模板 

[各类基础算法模板](https://github.com/youngyangyang04/leetcode/blob/master/problems/0/算法模板.md)
...
大家好，我是程前序员Carl，哈工大师兄，ACM 校赛、黑龙江省赛、东北四省赛金牌、亚洲区域赛铜牌获得者，先后在腾讯和百度从事后端技术研发，CSDN博客专家。对算法和C++后端技术有一定的见解，利用工作之余重新刷leetcode。 
...
**「代码随想录」每天准时为你推送一篇经典面试题目，帮你梳理算法知识体系，轻松学习算法！**，并且公众号里有大量学习资源，也有我自己的学习心得和方法周总结，更有上万录友们在这里打卡学习。
