...
![sychronize](https://txxs.github.io/pic/interviewGuide-storage/sychronize.png)

就是Java对象的内存布局其实由对象头+实例数据+对齐填充三部分组成，而对象头主要包含Mark Word+指向对象所属的类的指针组成。Mark Word主要用于存储对象自身的运行时数据，哈希码，GC分代年龄，锁标志等。

![img](https://txxs.github.io/pic/interviewGuide-storage/640的副本)

下面就是Mark Word的数据映射表

![image](https://txxs.github.io/pic/interviewGuide-storage/68747470733a2f2f757365722d676f6c642d63646e2e786974752e696f2f323031382f31312f32382f313637353964643162306239363236383f773d37323026683d32353026663d6a70656726733d3337323831.jpeg)
...
![img](https://txxs.github.io/pic/interviewGuide-storage/640-20201128120828359)
...
流程图如下：![img](https://txxs.github.io/pic/interviewGuide-storage/640-6536508.png)
...
![image-20200516203659737](https://txxs.github.io/pic/interviewGuide-storage/image-20200516203659737.png)
...
![图片](https://txxs.github.io/pic/interviewGuide-storage/640-3893313.png)
...
![图片](https://txxs.github.io/pic/interviewGuide-storage/640-20210221154207974.png)
